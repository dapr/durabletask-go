...
type BackendServiceClient interface {
	...
	GetOrchestrationRuntimeState(ctx context.Context, in *GetWorkflowRuntimeStateRequest, opts ...grpc.CallOption) (*GetWorkflowRuntimeStateResponse, error)
	...
	CompleteOrchestrationWorkItem(ctx context.Context, in *CompleteWorkflowWorkItemRequest, opts ...grpc.CallOption) (*CompleteWorkflowWorkItemResponse, error)
	...
	AbandonOrchestrationWorkItem(ctx context.Context, in *AbandonWorkflowWorkItemRequest, opts ...grpc.CallOption) (*AbandonWorkflowWorkItemResponse, error)
...
// Deprecated: Do not use.
func (c *backendServiceClient) GetOrchestrationRuntimeState(ctx context.Context, in *GetWorkflowRuntimeStateRequest, opts ...grpc.CallOption) (*GetWorkflowRuntimeStateResponse, error) {
	out := new(GetWorkflowRuntimeStateResponse)
...
// Deprecated: Do not use.
func (c *backendServiceClient) CompleteOrchestrationWorkItem(ctx context.Context, in *CompleteWorkflowWorkItemRequest, opts ...grpc.CallOption) (*CompleteWorkflowWorkItemResponse, error) {
	out := new(CompleteWorkflowWorkItemResponse)
...
// Deprecated: Do not use.
func (c *backendServiceClient) AbandonOrchestrationWorkItem(ctx context.Context, in *AbandonWorkflowWorkItemRequest, opts ...grpc.CallOption) (*AbandonWorkflowWorkItemResponse, error) {
	out := new(AbandonWorkflowWorkItemResponse)
...
type BackendServiceServer interface {
	...
	// Deprecated: Do not use.
	// Deprecated: use GetWorkflowRuntimeState instead.
	GetOrchestrationRuntimeState(context.Context, *GetWorkflowRuntimeStateRequest) (*GetWorkflowRuntimeStateResponse, error)
	// Gets the history of a workflow instance as a stream of events.
	...
	// Deprecated: Do not use.
	// Deprecated: use CompleteWorkflowWorkItem instead.
	CompleteOrchestrationWorkItem(context.Context, *CompleteWorkflowWorkItemRequest) (*CompleteWorkflowWorkItemResponse, error)
	// Abandons an outstanding workflow work item. Abandoned work items will be
	// re-delivered after some delay.
	AbandonWorkflowWorkItem(context.Context, *AbandonWorkflowWorkItemRequest) (*AbandonWorkflowWorkItemResponse, error)
	// Deprecated: Do not use.
	// Deprecated: use AbandonWorkflowWorkItem instead.
	AbandonOrchestrationWorkItem(context.Context, *AbandonWorkflowWorkItemRequest) (*AbandonWorkflowWorkItemResponse, error)
	// Completes an outstanding entity work item.
...
func (UnimplementedBackendServiceServer) GetOrchestrationRuntimeState(context.Context, *GetWorkflowRuntimeStateRequest) (*GetWorkflowRuntimeStateResponse, error) {
...
func (UnimplementedBackendServiceServer) CompleteOrchestrationWorkItem(context.Context, *CompleteWorkflowWorkItemRequest) (*CompleteWorkflowWorkItemResponse, error) {
...
func (UnimplementedBackendServiceServer) AbandonOrchestrationWorkItem(context.Context, *AbandonWorkflowWorkItemRequest) (*AbandonWorkflowWorkItemResponse, error) {
...
func _BackendService_GetOrchestrationRuntimeState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServiceServer).GetOrchestrationRuntimeState(ctx, req.(*GetWorkflowRuntimeStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BackendService_CompleteOrchestrationWorkItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServiceServer).CompleteOrchestrationWorkItem(ctx, req.(*CompleteWorkflowWorkItemRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BackendService_AbandonOrchestrationWorkItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServiceServer).AbandonOrchestrationWorkItem(ctx, req.(*AbandonWorkflowWorkItemRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BackendService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "durabletask.protos.v1.BackendService",
