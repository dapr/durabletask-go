...
func (c *taskHubSidecarServiceClient) CompleteWorkflowTask(ctx context.Context, in *WorkflowResponse, opts ...grpc.CallOption) (*CompleteTaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CompleteTaskResponse)
	err := c.cc.Invoke(ctx, TaskHubSidecarService_CompleteWorkflowTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskHubSidecarServiceClient) RerunWorkflowFromEvent(ctx context.Context, in *RerunWorkflowFromEventRequest, opts ...grpc.CallOption) (*RerunWorkflowFromEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskHubSidecarService_RerunWorkflowFromEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskHubSidecarServiceClient) GetInstanceHistory(ctx context.Context, in *GetInstanceHistoryRequest, opts ...grpc.CallOption) (*GetInstanceHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskHubSidecarService_GetInstanceHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTaskHubSidecarServiceServer) RerunWorkflowFromEvent(context.Context, *RerunWorkflowFromEventRequest) (*RerunWorkflowFromEventResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RerunWorkflowFromEvent not implemented")
}
