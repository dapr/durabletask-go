...
var file_orchestrator_service_proto_rawDesc = []byte{
	...
	0x73, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x97, 0x03, 0x0a, 0x1d, 0x52,
	...
	0x77, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x44, 0x88, 0x01, 0x01, 0x12, 0x28,
	...
	0x6f, 0x75, 0x74, 0x65, 0x72, 0x88, 0x01, 0x01, 0x42, 0x10, 0x0a, 0x0e, 0x5f, 0x6e, 0x65, 0x77,
	0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x44, 0x42, 0x1d, 0x0a, 0x1b, 0x5f, 0x6e,
	0x65, 0x77, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x49,
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x44, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x72, 0x6f,
	0x75, 0x74, 0x65, 0x72, 0x22, 0x46, 0x0a, 0x1e, 0x52, 0x65, 0x72, 0x75, 0x6e, 0x57, 0x6f, 0x72,
	...
	0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x2a, 0x88, 0x01, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x6b,
	...
	0x26, 0x0a, 0x22, 0x57, 0x4f, 0x52, 0x4b, 0x45, 0x52, 0x5f, 0x43, 0x41, 0x50, 0x41, 0x42, 0x49,
	0x4c, 0x49, 0x54, 0x59, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x46, 0x55, 0x4c, 0x5f, 0x48, 0x49,
	0x53, 0x54, 0x4f, 0x52, 0x59, 0x10, 0x02, 0x22, 0x04, 0x08, 0x01, 0x10, 0x01, 0x2a, 0x23, 0x57,
	...
	0x4e, 0x47, 0x32, 0xe8, 0x08, 0x0a, 0x15, 0x54, 0x61, 0x73, 0x6b, 0x48, 0x75, 0x62, 0x53, 0x69,
...
var file_orchestrator_service_proto_depIdxs = []int32{
	...
	37, // 23: CreateInstanceRequest.router:type_name -> TaskRouter
	37, // 24: GetInstanceRequest.router:type_name -> TaskRouter
	42, // 25: GetInstanceResponse.workflowState:type_name -> WorkflowState
	31, // 26: RaiseEventRequest.input:type_name -> google.protobuf.StringValue
	37, // 27: RaiseEventRequest.router:type_name -> TaskRouter
	31, // 28: TerminateRequest.output:type_name -> google.protobuf.StringValue
	37, // 29: TerminateRequest.router:type_name -> TaskRouter
	31, // 30: SuspendRequest.reason:type_name -> google.protobuf.StringValue
	37, // 31: SuspendRequest.router:type_name -> TaskRouter
	31, // 32: ResumeRequest.reason:type_name -> google.protobuf.StringValue
	37, // 33: ResumeRequest.router:type_name -> TaskRouter
	19, // 34: PurgeInstancesRequest.purgeInstanceFilter:type_name -> PurgeInstanceFilter
	37, // 35: PurgeInstancesRequest.router:type_name -> TaskRouter
	41, // 36: PurgeInstanceFilter.createdTimeFrom:type_name -> google.protobuf.Timestamp
	41, // 37: PurgeInstanceFilter.createdTimeTo:type_name -> google.protobuf.Timestamp
	43, // 38: PurgeInstanceFilter.runtimeStatus:type_name -> OrchestrationStatus
	44, // 39: PurgeInstancesResponse.isComplete:type_name -> google.protobuf.BoolValue
	...
	31, // 43: RerunWorkflowFromEventRequest.input:type_name -> google.protobuf.StringValue
	37, // 44: RerunWorkflowFromEventRequest.router:type_name -> TaskRouter
	36, // 45: GetInstanceHistoryResponse.events:type_name -> HistoryEvent
	45, // 46: TaskHubSidecarService.Hello:input_type -> google.protobuf.Empty
	6,  // 47: TaskHubSidecarService.StartInstance:input_type -> CreateInstanceRequest
	8,  // 48: TaskHubSidecarService.GetInstance:input_type -> GetInstanceRequest
	8,  // 49: TaskHubSidecarService.WaitForInstanceStart:input_type -> GetInstanceRequest
	8,  // 50: TaskHubSidecarService.WaitForInstanceCompletion:input_type -> GetInstanceRequest
	10, // 51: TaskHubSidecarService.RaiseEvent:input_type -> RaiseEventRequest
	12, // 52: TaskHubSidecarService.TerminateInstance:input_type -> TerminateRequest
	14, // 53: TaskHubSidecarService.SuspendInstance:input_type -> SuspendRequest
	16, // 54: TaskHubSidecarService.ResumeInstance:input_type -> ResumeRequest
	18, // 55: TaskHubSidecarService.PurgeInstances:input_type -> PurgeInstancesRequest
	21, // 56: TaskHubSidecarService.GetWorkItems:input_type -> GetWorkItemsRequest
	2,  // 57: TaskHubSidecarService.CompleteActivityTask:input_type -> ActivityResponse
	5,  // 58: TaskHubSidecarService.CompleteOrchestratorTask:input_type -> WorkflowResponse
	5,  // 59: TaskHubSidecarService.CompleteWorkflowTask:input_type -> WorkflowResponse
	24, // 60: TaskHubSidecarService.RerunWorkflowFromEvent:input_type -> RerunWorkflowFromEventRequest
	26, // 61: TaskHubSidecarService.ListInstanceIDs:input_type -> ListInstanceIDsRequest
	28, // 62: TaskHubSidecarService.GetInstanceHistory:input_type -> GetInstanceHistoryRequest
	45, // 63: TaskHubSidecarService.Hello:output_type -> google.protobuf.Empty
	7,  // 64: TaskHubSidecarService.StartInstance:output_type -> CreateInstanceResponse
	9,  // 65: TaskHubSidecarService.GetInstance:output_type -> GetInstanceResponse
	9,  // 66: TaskHubSidecarService.WaitForInstanceStart:output_type -> GetInstanceResponse
	9,  // 67: TaskHubSidecarService.WaitForInstanceCompletion:output_type -> GetInstanceResponse
	11, // 68: TaskHubSidecarService.RaiseEvent:output_type -> RaiseEventResponse
	13, // 69: TaskHubSidecarService.TerminateInstance:output_type -> TerminateResponse
	15, // 70: TaskHubSidecarService.SuspendInstance:output_type -> SuspendResponse
	17, // 71: TaskHubSidecarService.ResumeInstance:output_type -> ResumeResponse
	20, // 72: TaskHubSidecarService.PurgeInstances:output_type -> PurgeInstancesResponse
	22, // 73: TaskHubSidecarService.GetWorkItems:output_type -> WorkItem
	23, // 74: TaskHubSidecarService.CompleteActivityTask:output_type -> CompleteTaskResponse
	23, // 75: TaskHubSidecarService.CompleteOrchestratorTask:output_type -> CompleteTaskResponse
	23, // 76: TaskHubSidecarService.CompleteWorkflowTask:output_type -> CompleteTaskResponse
	25, // 77: TaskHubSidecarService.RerunWorkflowFromEvent:output_type -> RerunWorkflowFromEventResponse
	27, // 78: TaskHubSidecarService.ListInstanceIDs:output_type -> ListInstanceIDsResponse
	29, // 79: TaskHubSidecarService.GetInstanceHistory:output_type -> GetInstanceHistoryResponse
