...
// bulk loader in NewOrchestrationRuntimeState. When seen is nil the
// resolution-key duplicate check scans OldEvents and NewEvents; otherwise the
// set is consulted and updated.
